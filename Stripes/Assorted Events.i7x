Version 5 of Assorted Events by Stripes begins here.
[version 4.5 - Brutus on the Lovers Bench MM/MF/FF]
[Version 5 - Reworked "My own zoo playset" event as part of Giant rework - Gherod]
...
to say ResolveEvent Suddenly Ninjas:
	...
	if lost is 1:
		...
		MultiInfect "Ninja Cat" repeats 2;
	else:
...
to say ResolveEvent Tour Bus:
	say "     The twisted wreck of a tour bus fallen over onto its side sprawls across the derelict street, its bulk interrupting your path through the crumbling urban landscape. Surrounding it, a grotesque pile-up of cars suggests a truly catastrophic event. Twisted metal and shattered glass litter the asphalt, remnants of the beginning of the nanite apocalypse. Navigating this chaotic blockade requires careful maneuvering, picking your way through overturned vehicles and scattered debris. The detour adds unwelcome minutes to your journey, and you make a mental note made to avoid this particular route in the future. Despite the potential of danger, a faint hope stirs within you for potential salvage, drawing your attention to the silent behemoth.";
	say "     The bus's torn asunder front window seems like a gaping maw of twisted laminates and jagged shards. Through the ragged opening, a disturbing tableau unfolds within the interior. Splashes of what appears to be dried cum stain every surface - the ceiling, now a wall, the seats, the floor. Claw marks gouge upholstery, and a faint, sickly sweet aroma wafts out to your nostrils. Clearly, the crash was no ordinary accident; the sheer volume of biological residue suggests a sudden, violent transformation of its passengers into horny beasts, driven to a mating frenzy before, or perhaps even during, the impact. Among the sticky, contaminated chaos, however, you see the scattered clothes and posessions of the passengers, representing tempting targets strewn about in a precarious environment crusty with nanite-infused bodily fluids.";
	let Tour_Bus_Choices be a list of text;
	add "Try to salvage something from the bus." to Tour_Bus_Choices;
	add "Stay far away from that mess and leave." to Tour_Bus_Choices;
	let Tour_Bus_Choice be what the player chooses from Tour_Bus_Choices;
	LineBreak;
	if Tour_Bus_Choice is:
		-- "Try to salvage something from the bus.":
			say "     Making the choice to investigate, you move closer, instinctively giving the jagged opening in the front window a wide berth. Instead, your attention shifts to a car, a sedan, wedged awkwardly beneath what was once the bus's left side. Climbing onto the sedan's crumpled back and carefully crossing over its roof, you reach the bus's edge. There, you find a section where a side window has been entirely blown out, creating an optimal entry point - a convenient, if jagged, gap. Someone certainly used this as an emergency exit after the crash. With slow, deliberate movements, you position yourself to descend.";
			say "     Peering through the wide opening, the interior of the bus presents a grotesque landscape of ruin and bodily fluids. Streaks of dried cum cling to the fabric of the upturned seats, and the side wall that is now forming a treacherous floor, alongside splintered plastic and twisted metal. Sharp shards of glass gleam ominously in the dim light filtering through the grime-coated windows. Your gaze sweeps across the chaos, assessing the hazards, before locking onto any piece of fabric that is recognizable. There, that looks promising: A faded green canvas backpack, hanging precariously in the air on the far side, within reach of a careful approach.";
			WaitLineBreak;
			say "     Extending a leg, you carefully feel for a solid foothold amidst the wreckage. A foot finds purchase on the edge of a seat, now a horizontal platform, surprisingly stable despite the bus's acute tilt. With slow, controlled effort, you lower yourself into the bus's interior, muscles tensing with each movement, keen to avoid any suspicious sticky residue. The air inside is thick and stale, a faint, sweet, and faintly metallic odor assaulting your senses. Once both feet are firmly on what was formerly a side wall, now serving as a precarious footing, you take a moment to straighten, stretching your back and limbs, adjusting to the disorienting slant of the vehicle.";
			say "     Navigating the overturned cabin becomes a delicate dance of avoidance. Each step is carefully placed, sidestepping patches of sticky, dried gunk and bypassing jagged glass shards embedded in the upholstery of the horizontally jutting seats. The faint, sweet smell is ever present around you, a constant reminder of the unseen nanite threat. Your eyes remain fixed on the faded green backpack, a beacon of potential utility in this contaminated wasteland, hanging from an overhead rack that now juts out from the side-wall. Reaching the target, you grasp the strap, careful not to brush against the stained fabric or anything nearby. With a firm tug, you free the bag from its snagged position. Clutching the backpack tightly, you begin the arduous journey back towards the makeshift exit.";
			...
			if diceroll + bonus >= 14:
				LineBreak;
				say "     The added weight of the bag introduces a new challenge to the ascent. Each handhold is chosen with extreme caution, ensuring it is free of any slick residue or sharp edges. The overturned interior groans softly under your shifting weight, a symphony of stressed metal and creaking plastic. Slowly, methodically, you hoist yourself back up, your head emerging from the blown-out side window, a breath of comparatively fresh, albeit still dusty, air filling your lungs.";
				say "     With a final push, you clear the lip of the window, pulling yourself fully onto the back of the car below. The sedan groans under your weight, its crumpled frame shifting slightly. Carefully, you move across its dented roof, then slide down its battered trunk, your feet finally meeting the scraped asphalt with a welcome solidity. The ripped backpack, now in your hand, feels lighter than expected, its canvas torn in a few places from its ordeal. It isn't wearable, but the bulge of objects inside hints at possible treasures, a small victory salvaged from the wreck of desperation and transformation.";
			else:
				say "     As you begin your ascent, the weight of the bag throws your balance for a moment. Your searching hand reaches for a seemingly clear handhold on an upturned seat, but your fingers land on a patch of slick, and surprisingly still wet cum. Seems like it was much more recent deposit than most of this mess. A gasp escapes your lips as your hand slips, sending a jolt of alarm through you as your body pitches sideways. For a terrifying second, you dangle, exposed, your skin instantly tingling where the nanite-infused fluid coats your palm. You regain your footing with a desperate lurch, pulling yourself back to stability, but the strange, buzzing sensation on your skin lingers, an unsettling reminder of the contact.";
				say "     With renewed caution, you complete the arduous journey back towards the makeshift exit. Each movement is slow, deliberate, as you hoist yourself up and out. Your head emerges from the blown-out side window, and you gulp down a breath of comparatively fresh, albeit still dusty, air. With a final push, you clear the lip of the window, pulling yourself fully onto the back of the car below. The sedan groans under your weight, its crumpled frame shifting slightly. Carefully, you move across its dented roof, then slide down its battered trunk, your feet finally meeting the scraped asphalt with a welcome solidity. Immediately, you rub your tingling hand vigorously against a stained, fabric-covered seat in a nearby wrecked car, trying to scrape off any remnants of the offending residue. The ripped backpack, now in your other hand, feels lighter than expected, its canvas torn in a few places from its ordeal. It isn't wearable, but the bulge of objects inside hints at possible treasures, a small victory salvaged from the wreck of desperation and transformation.";
				infect "Cougar";
			WaitLineBreak;
			say "     You pull open the ripped backpack and perceive a faint, sweet smell, rising from its depths that makes you cautious. Inside, nestled among tattered papers, you find a small, still-sealed water bottle, three chocolate bars - somewhat squished but still edible - and a pristine package of bandages. A paperback novel also lies within, but its cover looks distorted and wavy, like it got soaked and dried again. Upon inspection, you notice a patch of dried residue on the inner lining of the backpack's side, which was in contact with the book. With a grimace, you pull the useful items free, discarding the contaminated book and the compromised pack itself. The salvaged supplies - hydration, energy, and medical aid - quickly join the contents of your own, uncontaminated pack.";
			say "     A surge of quiet satisfaction fills you, the useful finds from the tattered backpack a small victory in this desolate landscape. Just as you begin to contemplate your next move, a low, guttural growl rips through the stillness from somewhere behind the overturned bus. Your head snaps around, eyes scanning the chaotic scene. From the shadowed underside of a nearby wrecked truck, a human-sized, furry form emerges. A hermaphrodite anthro cougar steps into view, her feline eyes gleaming with predatory intent. A tattered bus driver's cap clings precariously to her head, while a stained, oversized jacket hangs loosely from her broad shoulders, hinting at her former occupation. She lets out another menacing rumble, then drops her heavy frame to the asphalt, charging forward with surprising speed and agility, her intent undeniably hostile.";
		...
		-- "Stay far away from that mess and leave.":
			say "     Sometimes caution is the best way to stay safe, so you keep your distance to the broken and dirty mess that the bus has become. As you gain some distance from the pileup and look back, you see an anthro cougar prowl about between the cars. Seems like you made the right decision, avoiding a confrontation with the busty female.";
...
to say ResolveEvent Trickster:
	...
	say "[line break]     [bold type]Do you move to join the soldiers or run and hide to watch what happens?[roman type][line break]";
	...
	if Player consents:
		...
		say "You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]16[roman type] (Dexterity Check):[line break]";
...
to say ResolveEvent Prank Aftermath:
	...
	if Libido of Player - humanity of Player < -25:
		say "     Not normally native to this part of the city, you start to wonder how such a large band of the felines got here when you spot one of them eating a large fish from a basket while she waits for her next turn with the new breedtoys. Remembering that you told Diego an idea you had about using fish to lure some of the felines around for a prank, it seems you've run into the aftermath of your idea. Being too far gone into your lustful urges and the infection taking over, you feel some remorse for your actions, but are too aroused by what you see to do anything but watch.";
		SanLoss 10;
		...
		say "     Not normally native to this part of the city, you start to wonder how such a large band of the felines got here when you spot one of them eating a large fish from a basket while she waits for her next turn with the new breedtoys. Remembering that you told Diego an idea you had about using fish to lure some of the felines around for a prank, it seems you've run into the aftermath of your idea. You find the sight strangely arousing, though your guilt over assisting in the infection of these soldiers does sadden you.";
...
to say ResolveEvent Lovers Bench:
	if loversbench is 0:				[first visit]
		...
		repeat with companion running through companionList of Player:
			if printed name of companion is not listed in lbcomplist and Player is not neuter:
				if pink raccoon is listed in companionList of Player:
					...
					if Player is male:
						...
						CreatureSexAftermath "Queen Bee" receives "PussyFuck" from "Player";
					else:
						...
						CreatureSexAftermath "Queen Bee" receives "OralPussy" from "Player";
					...
					if Player is male:
						...
						CreatureSexAftermath "Mental Mouse" receives "PussyFuck" from "Player";
					else:
						...
						CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Mental Mouse";
					...
					if Player is purefemale or ( Player is female and Player is submissive ):
						...
						CreatureSexAftermath "Player" receives "AssFuck" from "Black Equinoid";
					else:
						...
						if Player is male: [male+herm]
							if anallevel > 1:	 [anal sex not blocked]
								...
								if DBAnalScene < 5: [player fucks Brutus]
									...
									WaitLineBreak;
									say "     As you lean against the backrest of the bench, still in the grip of the amazing feelings coursing through your body, Brutus asks, 'Have I pleased you, master?', earning a nod and very satisfied smile from you. Giving a sound that resembles a very deep purr, the demon brings both his hands up to his massive erection, using them to jerk himself off. Quickly getting ready to cum, he pushes it in between your ass-cheeks, right against your pucker - and blows a hot burst of demonic seed into you. The force of his spurts alone is enough to push open your iris and you can feel shot after shot jet deep into your body. A warm feeling begins to spread through your insides as the demon fills you with his seed. With the sheer amount he's shooting, quite a bit immediately leaks out of your chock-full ass and runs over the wooden bench before dripping to the ground.";
									WaitLineBreak;
								...
								WaitLineBreak;
								say "     With how wound up you were right from the start and Brutus's skillfully performed blowjob, it doesn't take all that long until you feel the need to cum rise in your balls. Gripping the demon's head by his horns, you push him down tightly against your crotch and blow your load into his mouth, with Brutus eagerly swallowing spurt after spurt of your cum. He keeps your manhood in his mouth, softly sucking on it as your orgasm runs its course, waiting for even the last drop of your seed. Finally, you pull Brutus's head off your softening cock, then give him a deep kiss, tasting your load on his lips.";
					...
					raise Player Libido by ( 100 - Libido of Player ) / 4;
	...
	if HP of Joanna >= 7 and HP of Joanna < 90:		[Joanna's seed]
		...
		if Player consents:
			...
			if lost is 0:
				...
				CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Parasitic Plant";
...
Scent of tasty peach is "The oversized peach smells delicious and tempting.".
...
to say yummypeach:
	if "Junk Food Junky" is listed in feats of Player:
		...
		say "     You decide to take a bite out of the juicy peach, savoring its soft flesh as you eat it. The fruit slakes your hunger and thirst a little, though you can't help but become a little aroused as well. Peaches have been called aphrodisiacs by some, after all.";
		PlayerDrink 6;
		PlayerEat 3;
...
to say ResolveEvent Concession Stand:
	if foodvendor is 0:
		...
		say "[line break]     [bold type]'So, we got a deal?' he asks, holding out his hand.[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
		...
		say "[line break]     [bold type]Shall you return to his stand?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
...
This is the Ever-Shifting Pet rule:
	if ending "Ever-Shifting Pet" is triggered:
		say "     Your shapeshifting master is true to his word and keeps you as a lustful pet, fucking you in a myriad of ways and in an infinite combination of bodies. He changes you again and again, spending days or weeks as canines, felines, equines and every other creature. Almost fully human at times to completely animal at others. Any form his mind desires and always changing you to another before either of you can become bored of it. [if Player is MalePreferred]You smile happily as he ensnares others to add to his harem over time, giving you playmates to enjoy. He alters them to suit his whims as well, creating even greater variety in the pleasures for you to experience[else if Player is FemalePreferred]You smile happily as he ensnares others to add to his harem over time, giving you playmates to enjoy. He alters them to suit his whims as well, creating even greater variety in the pleasures for you to experience. You are bred by him and his pets on numerous occasions, birthing different creatures and hybrids every time[else if Player is HermPreferred]You smile happily as he ensnares others to add to his harem over time, giving you playmates to enjoy. He alters them to suit his whims as well, creating even greater variety in the pleasures for you to experience. You are bred by him and his pets on numerous occasions, birthing different creatures and hybrids every time. Your master takes to becoming a female or a herm at times so you may enjoy breeding her and the other pets on occasion[else]Not even your gender is fixed, changing from males to females and anything in between. You smile happily as he ensnares others to add to his harem over time, giving you playmates to enjoy. He alters them to suit his whims as well, creating even greater variety in the pleasures for you to experience. You are bred by him and his pets on numerous occasions, birthing different creatures and hybrids every time. Your master takes to becoming a female or a herm at times so you may enjoy breeding her and the other pets on occasion[end if].";
		if hellHoundLevel > 0:
...
to say ResolveEvent Beach Party:
	...
	if fightoutcome < 20: [player won]
		...
		if humanity of Player < 10:
			say "     Having the air-headed dolphin girls lavish so much attention onto you, you can't help but feel yourself fading away some, as if you're becoming more empty-headed and giggly like them. You rise to your feet easily, feeling as if buoyed by your own happy feelings and look over your body, fully that of an inflatable dolphin like those pretty girls. With your mind fading away, you giggle happily and bound off into the water to play with your new friends as you forget yourself entirely and become a fun-loving beach toy.";
			wait for any key;
			...
			say "     Having the air-headed dolphin girls lavish so much attention onto you, you can't help but feel yourself fading away some, as if you're becoming more empty-headed and giggly like them. You rise to your feet easily, feeling as if buoyed by your own happy feelings and look over your body, fully that of an inflatable dolphin like those pretty girls. You manage to keep your mind together enough to leave the dolphin girls and with their large dolphin toy to continue their partying. As you walk back along the beach, you can hear a few cries of disappointment, but the giggling and playing starts up again moments afterwards. You're quite sure they won't pursue you, but you decide to head back and wait for them to finish their beach party before passing this way again.";
...
to say ResolveEvent My Own Zoo Playset:
	...
	WaitLineBreak;
	say "     At the moment, he's got a tigertaur and a panda girl in his hands, pressing them up against one another rather roughly. It's clear that they're too scared to kiss, or fight, or make out, or whatever he has in mind, but he doesn't seem to notice or care, having a simple grin on his face. As this is going on, you spot a door open very slowly on one of the battered cars and a rather nervous zebra pokes his head out. Confirming that the giant's occupied, he hops out of the car and staggers off as quick as his battered body can take him. Unfortunately for all involved, he doesn't get far before he's noticed by the giant. The startled giant tosses the two in his hands back into the enclosure, dropping them about twenty feet and leaving them dazed. He lumbers to his feet and charges after the zebra, who is running right for the nearest cover... the trees you're hiding in right now!";
	let T be a random number between 1 and 20;
	if "Stealth" is listed in feats of Player, increase T by 3;
	if T < 9:
		say "     Knocking over several trees in his search, the giant spots you trying to hide. Forgetting about the zebra, he turns his attention on you. There's nowhere to run, and he gets hold of you easily.";
		say "[WalkToGiant]";
		now Resolution of My Own Zoo Playset is 1; [Snatched by Human Giant]
	else if T < 17:
		...
		say "     Having seen plenty and afraid of being caught by the giant while he's in the mood to give the animals some [']playtime['], you back out of the trees and try to get some distance between the two of you.";
